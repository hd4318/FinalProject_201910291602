...
from module.preprocess import MecabTokenizer, NltkTokenizer

from model.optim import GradualWarmupScheduler
from module.evaluate_transformer import token_decoder, evaluate
...
def ensure_vocab_embedding(
    ...
    if not os.path.exists(vocab_file_path) or not os.path.exists(word_embedding_file_path):
        ...
        print(f'{tag} embedding information does not exist.')
